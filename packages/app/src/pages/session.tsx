  ...
  command.register(() => [
    ...
    },
    {
      ...
      onSelect: () => {
        ...
        showToast({
          title: "思考强度已变更",
          description: "当前思考强度：" + (local.model.variant.current() ?? "默认"),
        })
      },
    },
    {
                  ...
                  <Tabs.List>
                    ...
                    <Show when={contextOpen()}>
                      <Tabs.Trigger
                        value="context"
                        closeButton={
                          <Tooltip value="关闭标签" placement="bottom">
