...
export const PatchTool = Tool.define("patch", {
  description:
    "Apply a patch to modify multiple files. Supports adding, updating, and deleting files with context-aware changes. Skill files are read-only: do not patch any path under .yaklang/skill or .claude/skills.",
