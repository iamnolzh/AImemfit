 ...
 * Protects .yaklang/skill, .yaklang/skills, .claude/skills so that even if the AI tries to
...
export const SKILL_PROTECTED_MESSAGE =
  "Skill files are read-only and cannot be modified. Do not edit, write, or patch any file under .yaklang/skill or .claude/skills. If a skill failed to load or has errors, report the error to the user instead of changing the skill file."
